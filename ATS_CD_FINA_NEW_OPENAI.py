...
def get_gemini_response(job_description, resume_text, jd_match, position_match): #calculating jd_match and position_match instead of using llm to control halucination
